...
export const zh_CN: Translation = {
	...
	// 技能展示页面
	[Key.skills]: "技术栈与能力边界",
	[Key.skillsSubtitle]: "以后端和 Agent 为主，记录我能独立做什么、熟悉什么，以及正在补什么。",
	[Key.skillsFrontend]: "前端协作",
	[Key.skillsBackend]: "后端开发",
	[Key.skillsDatabase]: "数据与缓存",
	[Key.skillsTools]: "工程与交付",
	[Key.skillsOther]: "Agent / AI",
	[Key.skillLevel]: "熟练度",
	...
	[Key.skillsExpert]: "核心方向",
	[Key.skillsAdvanced]: "主力实践",
	[Key.skillsIntermediate]: "项目实践",
	[Key.skillsBeginner]: "学习与使用中",
