...
export const siteConfig: SiteConfig = {
	title: "ZeroMadLife",
	subtitle: "面向 Agent 工程与后端实践的个人知识库",
	siteURL: "https://blog.sagecompanion.top/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-07-18", // 站点开始运行日期，用于站点统计组件计算运行天数
	keywords: ["Agent 工程", "SAGE", "Java", "后端", "知识库"],
	...
	banner: {
		...
		homeText: {
			enable: true,
			title: "记录问题，验证判断，留下证据",
			switchable: true,

			subtitle: [
				"Agent 工程、后端基础与长期成长的公开记录",
				"把一次探索整理成可以检索、验证和复盘的知识",
				"不追逐热闹的指标，只留下可解释的工程证据",
				"本地 Markdown 写作，静态构建，AI 协助维护",
				"从问题出发，经过实践，回到下一轮问题",
			],
			typewriter: {
